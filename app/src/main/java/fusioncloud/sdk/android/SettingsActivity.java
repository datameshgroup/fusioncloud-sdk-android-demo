...
*/
    ...
    private void getvalues() {
        txtSalesID.setText(Settings.SALE_ID);
        txtPOIID.setText(Settings.POI_ID);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        try{
            Settings.POI_ID = txtPOIID.getText().toString();
            Settings.SALE_ID = txtSalesID.getText().toString();
